//
//  businessAdministrationView.swift
//  KU-rala
//
...
struct businessAdministrationView: View {
    var body: some View {
        VStack {
            Image("noProduct")
            ...
            .navigationTitle("Business Administration")
...
struct businessAdministrationView_Previews: PreviewProvider {
